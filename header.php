...
<head>
    ...
    <?php if (is_front_page()) { ?>
        ...
        <meta name="description"
              content="IJME is a comprehensive, open access, platform for discussions on bioethics, medical ethics, and healthcare justice in India and the developing world."/>
    <?php } else { ?>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 i-header-logo">
            <a href="<?php echo site_url(); ?>"><img src="<?php echo THEME_URL; ?>/images/logo.jpg"
                                                     alt="Page Header"></a>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nav-top-btn-container">
            <div class="top-nav-btnI top-nbc-logo">
                <a href="https://ijme.in/nbc-20140321/index.php/nbc-6/index/pages/view/under_construction">
                    <img src="<?php echo THEME_URL; ?>/images/nbc.jpg" alt="NBC LOGO">
                </a>
            </div>
            <div class="top-nav-btnI border"><a href="<?php echo site_url(); ?>/about-us/fmes/overview/"><img
                            src="<?php echo THEME_URL; ?>/images/FMES_logo_color_compressed.png" alt="fmes"></a></div>
