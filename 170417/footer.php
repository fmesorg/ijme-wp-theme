        ...
        <div class="footer">            
            ...
            <div class="container">
				...
				<a href="https://twitter.com/indjmedethics" style="float:right; " target="_blank"><img src="<?php echo THEME_URL; ?>/images/twitter.png"></i></a>
				<a href="https://www.facebook.com/Indian-Journal-of-Medical-Ethics-364396217255084/" target="_blank" style="float:right;padding-right:10px;"><img src="<?php echo THEME_URL; ?>/images/facebook.png"></i></a>
            </div>
        </div>
        <?php wp_footer(); ?>
        <script>
