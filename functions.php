    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                ...
                <p>
                    <a href="javascript:void(0);" class="button" onclick="return add_more_peers(this);">Add More Peer Reviewer</a>
                </p>
            </td>
        </tr>
        <tr>
...
function generate_xml_btn(){
    ...
    if($post_type == 'articles'){
        ?>
        <div>
            <input name="save" type="button" class="button-large button-primary" value="Generat XML" onclick="window.open('<?php echo "/wp-json/xmlGenerator/v1/xml/".$article_id;?>','_blank');" />
        </div>
    <?php }
    elseif ($post_type == 'issues'){ ?>
        <div>
            <input name="save" type="button" class="button-large button-primary" value="Generat ISSUE XML" onclick="window.open('<?php echo "/wp-json/xmlGeneratorIssue/v1/xml/".$article_id;?>','_blank');" />
        </div>
        <?php
    }
}
